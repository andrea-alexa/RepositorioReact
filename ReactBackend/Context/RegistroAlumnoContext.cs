...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-G7ROBOV1;Initial Catalog=RegistroAlumno;User ID=Andrea;Password = 221223;Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83FE63AD7D2");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83FE2D636B6");
            ...
            entity.HasOne(d => d.ProfesorNavigation).WithMany(p => p.Asignaturas)
                ...
                .HasConstraintName("FK__asignatur__profe__4F7CD00D");
        });

        modelBuilder.Entity<Calificacion>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83F00A3D800");
            ...
            entity.HasOne(d => d.Matricula).WithMany(p => p.Calificacions)
                ...
                .HasConstraintName("FK__calificac__matri__5629CD9C");
        });

        modelBuilder.Entity<Matricula>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F431FF45E");
            ...
            entity.HasOne(d => d.Alumno).WithMany(p => p.Matriculas)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__matricula__alumn__52593CB8");

            entity.HasOne(d => d.Asignatura).WithMany(p => p.Matriculas)
                .HasForeignKey(d => d.AsignaturaId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__matricula__asign__534D60F1");
        });

        modelBuilder.Entity<Profesor>(entity =>
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC77F8264A6");
